...
public class VisorandoService {
	...
	public Mono<List<Rando>> searchBbox(String bbox, Authentication auth) {
		...
		return client.get()
		.uri("/?component=rando&task=searchCircuitV2Ajax&geolocation=0&metaData=&minDuration=0&maxDuration=720&minDifficulty=1&maxDifficulty=5&loc=&retourDepart=0&multilang=on&bbox=" + bbox)
